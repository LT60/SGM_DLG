...
BEGIN_MESSAGE_MAP(SEARCH, CDialogEx)
	ON_BN_CLICKED(IDC_RADIO_SNUM, &SEARCH::OnBnClickedRadioSnum)
	ON_BN_CLICKED(IDC_RADIO_SID, &SEARCH::OnBnClickedRadioSid)
	ON_BN_CLICKED(IDC_RADIO_SNAME, &SEARCH::OnBnClickedRadioSname)
	ON_BN_CLICKED(IDC_RADIO_SCLASS, &SEARCH::OnBnClickedRadioSclass)
	ON_BN_CLICKED(IDC_BUTTON_BSSEARCH, &SEARCH::OnBnClickedButtonBssearch)
END_MESSAGE_MAP()
...
BOOL SEARCH::OnInitDialog()
{
	...
	searchlistscreen.InsertColumn(3, _T("学号"), LVCFMT_CENTER, 260);
	searchlistscreen.InsertColumn(4, _T("班级"), LVCFMT_CENTER, 150);
	searchlistscreen.InsertColumn(5, _T("语文"), LVCFMT_CENTER, 50);
	searchlistscreen.InsertColumn(6, _T("数学"), LVCFMT_CENTER, 50);
	searchlistscreen.InsertColumn(7, _T("英语"), LVCFMT_CENTER, 50);
	searchlistscreen.InsertColumn(8, _T("体育"), LVCFMT_CENTER, 50);
	searchlistscreen.InsertColumn(9, _T("生日"), LVCFMT_CENTER, 200);
...
void SEARCH::OnBnClickedRadioSnum()
{
	// TODO: 在此添加控件通知处理程序代码
	leader = 1;
}
...
void SEARCH::OnBnClickedRadioSid()
{
	// TODO: 在此添加控件通知处理程序代码
	leader = 2;
}
...
void SEARCH::OnBnClickedRadioSname()
{
	// TODO: 在此添加控件通知处理程序代码
	leader = 3;
}
...
void SEARCH::OnBnClickedRadioSclass()
{
	// TODO: 在此添加控件通知处理程序代码
	leader = 4;
}
...
void SEARCH::OnBnClickedButtonBssearch()
{
	// TODO: 在此添加控件通知处理程序代码
...
LinkList SEARCH::GetANode(int num, unsigned long long int id, CString name, CString inclass,LinkList pnode)
{
	// TODO: 在此处添加实现代码.
	while (pnode!=NULL)
	{
...
bool SEARCH::FindShow(int innum, unsigned long long int inid, CString inname, CString inclass,LinkList pnode)
{
	// TODO: 在此处添加实现代码.
	bool isfind = 0;
...
// 把一个pnode内的数据显示在第i行
void SEARCH::ShowANode(LinkList pnode)
{
	// TODO: 在此处添加实现代码.
	...
	searchlistscreen.SetItemText(i, 5, tempText);			//显示语文成绩
	tempText.Format(_T("%d"), pnode->student.Math);
	searchlistscreen.SetItemText(i, 6, tempText);			//显示数学成绩
	...
	searchlistscreen.SetItemText(i, 9, pnode->student.Birthday);//显示生日
